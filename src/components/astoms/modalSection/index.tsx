      ...
      {dataModal.show && !dataModal.submit ? (
        <div className={`${classes.root}`}>
          ...
          <div className={`${classes.content} bg-gray-box border border-solid border-gray-boxline-50`}>
            ...
            {dataModal.view_ticket ? (<ViewTicket dataGiveViewTicket={dataGiveViewTicket} dataSendViewTicket={dataModal} playerData={playerData}></ViewTicket>) : ''}
            {dataModal.view_your && playerData.is_connect ? (<ViewYour dataSendViewYour={dataModal} playerData={playerData}></ViewYour>) : ''}
          </div>
        </div>
      ) : (
        dataModal.show && dataModal.submit ? (
