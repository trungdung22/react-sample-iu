...
const Millionsy: React.FC = () => {
  ...
  const startDate = new Date('Nov 01, 2021 18:00:00').getTime();
  ...
  useEffect(() => {
    fetch(`${HOST_NAME}/api/milli-pads/milli-lottery/player/G5miZeRDAUVP7RymsnEir48bYMMy9g2H23NCrD7YghPw`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
      },
      ...
      if(response.status === 200) {
        ...
        registerMilipadPlayer('G5miZeRDAUVP7RymsnEir48bYMMy9g2H23NCrD7YghPw', ['goal1'], 'milli-lottery');
      }
    })
    ...
    <>
      ...
      <section className='px-3/100 mb-7 md:mb-10'>
        <div className='max-w-900 mx-auto relative mt-54 md:mt-57'>
          <p className='absolute top-2 md:top-4 left-2 md:left-4 transition-all hover:opacity-70 w-5 md:w-auto'><a href="/millipad"><img src="/assets/millipad/arrow_back.svg" alt="arrow_back"/></a></p>
            ...
            <div className='rounded-10 bg-gray-150 w-full'>
              ...
              <ul className='bg-gray-300'>
                ...
                
                {
                  ...
                  :
                  <>
                    <li className={`px-4 md:px-6 tablet992:px-12 py-3 text-12 md:text-14 text-pink-50 border-b border-gray-250 border-solid ${passSaleRound ? 'bg-purple-100' : ''}`}><span className='text-16 font-bold block md:inline-block'>Sale round<span className='hidden md:inline'>:</span></span> Only winners can participate in this round.</li>
